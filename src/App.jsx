...
var App = () => {
  ...
  const api_url = "https://www.omdbapi.com/?i=tt3896198&apikey=464205bf";
  ...
  var displayMovie = () => {
    if (response === "True") {
      ...
      return <h2 className="no-movie">No Movies Found😓</h2>;
    } else {
      return <h2 className="no-movie">❗No Internet Connection❗</h2>;
    }
  };
  return (
    <>
